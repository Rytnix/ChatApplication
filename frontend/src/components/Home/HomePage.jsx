...
import { currentUser, searchUser } from "../../Layers/Auth/Action";
import { createSingleChat, getAllChat } from "../../Layers/Chat/Action";
import { createNewMessage, getAllMessage } from "../../Layers/Message/Action";
...
const HomePage = () => {
  ...
  return (
    <div className="relative">
      <div className="py-14 bg-[#D63484] w-full"></div>
              ...
              <div className=" w-full ">
                ...
                <div className="relative flex justify-center items-center bg-white py-4 px-3">
                  <input
                    ...
                    value={querys}
                  />
                  <AiOutlineSearch className="absolute top-7 left-10" />
                  <div>
